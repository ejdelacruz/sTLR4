...
pri.cell <- d18.02.02 %>% filter(Sample.Name != "pt1a" & Sample.Name != "Saline") %>%
...
sups <- d18.02.02 %>% filter(Sample.Name!="pt1a" & Sample.Name!="Saline") %>%
...
g.pt1a <- ggplot(bvr01.pt1a, aes(x=days.since.lmp, y=tlr4.ngmL)) +
