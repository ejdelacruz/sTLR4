...
bvr01.4241 <- d18.02.02 %>% filter(Sample.Name=="4241") %>%
...
g.4241 <- ggplot(bvr01.4241, aes(x=days.since.lmp, y=tlr4.ngmL)) +
...
main.fig <- plot_grid(pri.cell.sups, nugent, tlr4, 
                      ectopy, cyclephase, g.4241, nrow=2, ncol=3, labels="AUTO")
